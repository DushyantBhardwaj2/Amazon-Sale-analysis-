...
An interactive Streamlit frontend has been added for this project at `frontend/app.py`.

### Features

- KPI cards for total revenue, total profit, average margin, and unique orders
- Interactive filters for year, region, and sales channel
- Monthly revenue trend chart
- Top item types by profit chart
- Profit by region chart
- Filtered table preview for drill-down analysis
- Advanced page for distributed database architecture (Kafka -> Spark -> Delta -> Cassandra)
- Simulated micro-batch streaming metrics and serving-table preview

### Run Locally

```bash
cd Amazon-Sales-Data-Analysis-Project-in-Pyspark
